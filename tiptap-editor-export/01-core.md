...
Editorun giriş nöqtəsi. Bütün panel düymələri, önizləmə/tam ekran rejimi və
`useEditor` konfiqurasiyası buradadır. Yükləmə funksiyaları **prop kimi**
ötürülür — daxildə sabit API ünvanı yoxdur.
