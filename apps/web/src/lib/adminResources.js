...
export const ADMIN_RESOURCES = {
  ...
  "quiz-categories": { name: "Test kateqoriyaları", title: "name", sub: "slug" },
...
export const RESOURCE_FILTERS = {
  ...
  "blog-categories": [ACTIVE],
    projects: [ACTIVE, { key: "isFeatured", label: "Ana səhifə", options: [{ value: "true", label: "Bəli" }, { value: "false", label: "Xeyr" }] }],
