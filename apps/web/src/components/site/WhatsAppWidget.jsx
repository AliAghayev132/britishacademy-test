  ...
  return (
    <div ref={ref}>
      ...
      <a
        ...
        style={{ position: "fixed", right: 22, bottom: 56, zIndex: 90, width: 78, height: 78, borderRadius: "50%", background: "#25D366", display: "grid", placeItems: "center", boxShadow: "0 14px 32px rgba(37,211,102,.5)", cursor: "pointer" }}
      >
